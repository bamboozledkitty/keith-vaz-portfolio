      ...
      return (
        <div className="h-full w-full flex flex-col justify-between p-5 group bg-white">
          ...
          <div className="min-w-0 w-full">
            <h3 className={cn(
              "font-semibold text-gray-900 leading-snug text-sm",
      ...
      return (
        <div className="flex h-full w-full bg-white group p-5 gap-4">
          ...
          <div className="flex-1 flex flex-col justify-start min-w-0 gap-3">
            ...
            <div>
              <h3 className={cn(
                "font-semibold text-gray-900 leading-tight text-base tracking-tight",
          ...
          {item.image ? (
            <>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex flex-col justify-end p-6">
                ...
                <h3 className="text-white font-semibold text-xl leading-tight tracking-tight">{item.title}</h3>
            ...
            <div className="h-full w-full flex flex-col p-6 justify-between bg-white">
              ...
              <div>
                <h3 className="font-semibold text-2xl text-gray-900 leading-tight tracking-tight">{item.title}</h3>
